...
class Args:
    ...
    def parse_args() -> "Args":
        ...
        argparser.add_argument(
            "--onnxruntime",
            default=f"./voicevox_core/example/python/onnxruntime/lib/{Onnxruntime.LIB_VERSIONED_FILENAME}",
            help="ONNX Runtimeのライブラリのfilename",
        )
        argparser.add_argument(
            "--dict-dir",
            default="./voicevox_core/example/python/dict/open_jtalk_dic_utf_8-1.11",
            type=Path,
